...
# idade_usuario = 18
# email = 'vini.markinhos@gmail.com'
# 
# if not 18 <= idade_usuario <= 65:
#     print("idade digitada fora do intervalo permitido")
...
# segundo exemplo criado com um numero especifico
# dados = []
# numero = ""
# while numero != 8:
#     numero = int(input("Digite o numero correto: "))
#     if numero != 8:
#         # Adicionar a entrada à lista de dados
#         dados.append(numero)
...
#   limite_max = 5
#   
#   while tentativa <= limite_max:
#       print(f"Tentativa {tentativa} de {limite_max}")
#       if True: #or False para cair no segundo bloco
#           print("Tentativa de conexão bem sucedida")
#           break
#       tentativa += 1
#   else:    
#       
#       print("Excesso de tentativas excedida.")
#   
###################################################################################
...
lista_de_compras = ["pera" , "uva" , "maça" , "salada mista"]
